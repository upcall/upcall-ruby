...
module Upcall
  class OauthAuthorizedApplicationsApi
    ...
    def fetch_oauth_authorized_applications_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/oauth/authorized_applications"
    ...
    def revoke_oauth_authorized_application_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OauthAuthorizedApplicationsApi.revoke_oauth_authorized_application"
      end
      # resource path
      local_var_path = "/oauth/authorized_applications/{id}".sub('{' + 'id' + '}', id.to_s)
