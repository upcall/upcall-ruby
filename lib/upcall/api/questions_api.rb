  ...
  class QuestionsApi
    ...
    def fetch_campaign_questions_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling QuestionsApi.fetch_campaign_questions"
      end
      # resource path
      local_var_path = "/campaigns/{id}/questions".sub('{' + 'id' + '}', id.to_s)
