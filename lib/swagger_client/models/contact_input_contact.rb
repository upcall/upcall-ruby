...
module SwaggerClient
  ...
  class ContactInputContact
    ...
    def hash
      [call_at, first_name, last_name, title, company, email, hints, number, extension, recipient, line1, line2, city, region, postal_code, country].hash
    end
