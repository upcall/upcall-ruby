...
module SwaggerClient
  class QuestionsApi
    ...
    def fetch_campaign_questions(id, opts = {})
      data, _status_code, _headers = fetch_campaign_questions_with_http_info(id, opts)
      return data
    end
    ...
    def fetch_campaign_questions_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QuestionsApi.fetch_campaign_questions ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling QuestionsApi.fetch_campaign_questions" if id.nil?
      # resource path
      local_var_path = "/campaigns/{id}/questions".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuestionsApi#fetch_campaign_questions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
