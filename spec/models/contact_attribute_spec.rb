...
# Unit tests for Upcall::ContactAttribute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactAttribute' do
  before do
    # run before each test
    @instance = Upcall::ContactAttribute.new
  end
  ...
  describe 'test an instance of ContactAttribute' do
    it 'should create an instance of ContactAttribute' do
      expect(@instance).to be_instance_of(Upcall::ContactAttribute)
    end
  end
