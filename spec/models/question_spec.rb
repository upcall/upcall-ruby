...
# Unit tests for SwaggerClient::Question
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Question' do
  before do
    # run before each test
    @instance = SwaggerClient::Question.new
  end
  ...
  describe 'test an instance of Question' do
    it 'should create an instact of Question' do
      expect(@instance).to be_instance_of(SwaggerClient::Question)
    end
  end
