...
# Unit tests for Upcall::QuestionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QuestionsApi' do
  before do
    # run before each test
    @instance = Upcall::QuestionsApi.new
  end
  ...
  describe 'test an instance of QuestionsApi' do
    it 'should create an instance of QuestionsApi' do
      expect(@instance).to be_instance_of(Upcall::QuestionsApi)
    end
  end
