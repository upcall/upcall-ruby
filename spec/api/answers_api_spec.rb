...
# Unit tests for SwaggerClient::AnswersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnswersApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AnswersApi.new
  end
  ...
  describe 'test an instance of AnswersApi' do
    it 'should create an instact of AnswersApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AnswersApi)
    end
  end
